...
public class ArrayList {
 public static void main(String[] args) {
     ...
     danhSachMatHang.add(new MatHang("Mặt hàng 1", 2, 500000));
     danhSachMatHang.add(new MatHang("Mặt hàng 2", 1, 1500000));
     danhSachMatHang.add(new MatHang("Mặt hàng 3", 5, 300000));
